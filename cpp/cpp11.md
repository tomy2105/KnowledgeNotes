...
Sorting operations `is_sorted` and  `is_sorted_until` are added as well as heap ones `is_heap` and  `is_heap_until`, i
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4MTAzNDQ4MywtMTAzMjIxNzY3NywtNz
